...
import ups.edu.ec.bancadis.on.LoginON;
    ...
    public String loginUser() {
        ...
        if (tipe != null) {
            if (tipe.equals("empleado")) {
                ...
                if (trabajador != null) {
                    if (trabajador.getActivo()) {
                        ...
                        if (trabajador.getRol().equals("Administrador")) {
                            return "empleado?faces-redirect=true&cedula=" + trabajador.getCedula();
                    ...
                    System.out.println("No ecuentra empleado");
                    return "loginc?faces-redirect=true&tipo=empledo&msj=cedula o contraseña incorrecta";
                }
                ...
                return "loginc?faces-redirect=true&tipo=empleado&msj=Erro: Verificar Tipo";
            }
        }else{
            return "loginc?faces-redirect=true&tipo=empleado&msj=Erro: Verificar Tipo";
        }
    ...
    public String actualizarCotra() {
        if (tipe.equals("empleado")) {
            if (contra1.equals(contra2)) {
                ...
                System.out.println("Contra de empleado actualizada");
                return "loginc?faces-redirect=true&tipo=empleado&msj=contraseña actualizada";
            } else {
