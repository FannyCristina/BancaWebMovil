...
a persistence unit "BancaWebMovillPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BancaWebMovill\pom.xml":
...
artifact ("BancaWebMovill.war") is already built. You can build
