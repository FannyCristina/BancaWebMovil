...
public class Solicitud implements Serializable {
    ...
    public Solicitud(Integer id, int plazo, String historial, String proposito, double cantidad, String saldocuenta, double tiempoempleo, double tasadepagos, String estadocivil, String garante, double avaluovivienda, String activos, int edad, String tipovivienda, int numerocreditos, String empleo, String trebajadorextrangero, String tipocliente, String estado) {
        this.id = id;
        this.plazo = plazo;
